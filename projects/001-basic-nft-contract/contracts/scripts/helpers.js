...
// Helper method for fetching a connection provider to the Energi network
function getProvider(hardhat) {
  ...
  return new ethers.providers.JsonRpcProvider(networkConfig.url, networkConfig.chainId);
}
